...
<?php
    ...
    require '../../../DSAGE/Model/PatternStrategy/StrategyInsertar.class.php';
    require '../../../DSAGE/View/headers/header.index.php';
    $producto = new Producto('',$_POST['nombre'], $_POST['precio'], $_POST['descripcion'], $_POST['preparacion'], $_POST['tipo']);
    ...
    var_dump($producto);*/
    echo $cliente->setStrategy(new StrategyInsertar());
    echo "<script>
